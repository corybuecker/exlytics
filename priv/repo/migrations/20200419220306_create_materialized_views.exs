defmodule Exlytics.Repo.Migrations.CreateMaterializedViews do
  use Ecto.Migration
  ...
  def up do
    execute("""
      ...
      FROM
        events
      WHERE
        metadata ->> 'host' in ('exlytics.corybuecker.com', 'analytics.corybuecker.com') and
        metadata ? 'page'
      GROUP BY
        day
      ;
